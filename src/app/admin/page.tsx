...
export default function AdminPanel() {
        ...
        <div className="space-y-4 sm:space-y-6">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 text-lg border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 farsi-item"
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <label className="flex items-center justify-center p-4 border-2 border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer transition-colors has-[:checked]:border-red-500 has-[:checked]:bg-red-50">
                <input
                  type="checkbox"
                ...
                />
                <span className="font-medium text-lg" style={{ color: '#000000' }}>North York</span>
              </label>
              <label className="flex items-center justify-center p-4 border-2 border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer transition-colors has-[:checked]:border-red-500 has-[:checked]:bg-red-50">
                <input
                  type="checkbox"
                  ...
                  className="mr-3 w-5 h-5 text-red-600"
                />
                <span className="font-medium text-lg" style={{ color: '#000000' }}>Thornhill</span>
              </label>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full py-4 px-6 bg-red-600 hover:bg-red-700 text-white rounded-lg font-bold text-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-red-600 shadow-lg hover:shadow-xl"
          >
            Add Item to Menu
          </button>
        </div>
                ...
                <div className="flex justify-between items-start mb-2">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      {order.location} • {order.orderDate?.toDate?.()?.toLocaleDateString() || 'N/A'} ({order.createdAt?.toDate?.()?.toLocaleTimeString([], {hour: '2-digit', minute:'2-digit'}) || 'N/A'}) • By: {order.placedByName}
                    </p>
                  </div>
  ...
  const renderUsersTab = () => (
    <div className="bg-white rounded-lg shadow p-6">
      ...
      <div className="mb-8">
        <h4 className="text-md font-semibold text-gray-800 mb-4">SMS Notification Settings</h4>
        <div className="bg-gray-50 rounded-lg p-4">
          <div className="space-y-4">
                        <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">
                Admin Phone Numbers for Order Notifications (up to 3):
              </label>
       ...
       <div className="mb-8">
         <h4 className="text-md font-semibold text-gray-800 mb-4">Twilio Configuration & Active Numbers</h4>
         <div className="bg-blue-50 rounded-lg p-4">
           <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm mb-4">
             <div>
               <span className="font-medium text-blue-800">Account SID:</span>
               <p className="text-blue-700 font-mono">AC48b87abef...a71</p>
             </div>
             <div>
               <span className="font-medium text-blue-800">SMS From Number:</span>
               <p className="text-blue-700">+1 (416) 578-4000</p>
             </div>
             <div>
             ...
             <div>
               ...
               <p className="text-blue-700">{adminPhoneNumbers.filter(num => num.trim()).length || 0} configured</p>
             </div>
           </div>
           {adminPhoneNumbers.filter(num => num.trim()).length > 0 && (
             <div className="border-t border-blue-200 pt-3">
               <span className="font-medium text-blue-800 text-sm">Configured Numbers:</span>
      ...
      {/* User Credentials */}
      <div>
        <h4 className="text-md font-semibold text-gray-800 mb-4">User Accounts</h4>
        <div className="bg-blue-50 rounded-lg p-4">
          <p className="font-medium text-blue-900 mb-3">Demo Credentials:</p>
          <div className="space-y-2">
            <div className="flex justify-between items-center p-2 bg-white rounded border">
              <div>
                <p className="text-sm font-medium text-gray-900">Administrator</p>
                <p className="text-xs text-gray-600">admin@shamshiri.com</p>
              </div>
            ...
            <div className="flex justify-between items-center p-2 bg-white rounded border">
              <div>
                ...
                <p className="text-xs text-gray-600">staff@shamshiri.com</p>
              </div>
              <span className="px-2 py-1 text-xs bg-green-100 text-green-800 rounded">Staff</span>
            </div>
          </div>
